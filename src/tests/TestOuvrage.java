...
public class TestOuvrage {
    ...
    public void testOuvrages() {
        ...
        Ouvrage livre3 = new Ouvrage("Musique du hasard", new Auteur("Paul", "Auster", new Pays("Etats-Unis")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
        ...
        Ouvrage livre4 = new Ouvrage("Test", new Auteur("A", "B", new Pays("Etats-Unis")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
    ...
    private void testTrouver() {
        ...
        List<Ouvrage> resultat = bibliotheque.trouverOuvrages(new Auteur("Albertine", "Tremblay", new Pays("Canada")));
